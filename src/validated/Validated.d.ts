...
export interface Validated<T> {
    apply<U, V>(this: Validated<(parameter: U) => V>, parameteOrFunction: U | Validated<U> | (() => U) | (() => Validated<U>)): Validated<V>;
    assign<T extends object, U>(this: Validated<T>, key: string, other: U | ((T: any) => U) | Validated<U> | ((value: T) => Validated<U>)): Validated<T & {
        [key in string]: U;
    }>;
