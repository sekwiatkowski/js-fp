...
export declare class None<A> implements Option<A> {
    ...
    assign<A extends object, K extends string, B>(this: None<A>, key: Exclude<K, keyof A>, memberOptionOrValueOrFunction: Option<B> | ((value: A) => Option<B>) | B | ((value: A) => B)): Option<A & {
        [key in K]: B;
    }>;
