...
export declare class Future<T, E> {
    ...
    assign<T extends object, K extends string, U>(this: Future<T, E>, key: Exclude<K, keyof T>, memberFutureOrPromiseValueOrFunction: Future<U, E> | ((value: T) => Future<U, E>) | Promise<U> | ((value: T) => Promise<U>) | U | ((value: T) => U)): Future<T & {
        [key in K]: U;
    }, E>;
