...
export declare class Success<T, E> implements Result<T, E> {
    ...
    assign<T extends object, K extends string, U>(this: Success<T, E>, key: Exclude<K, keyof T>, memberResultOrValueOrFunction: Result<U, E> | ((value: T) => Result<U, E>) | U | ((value: T) => U)): Result<T & {
        [key in K]: U;
    }, E>;
    toFuture(): Future<T, E>;
    toOption(): Option<T>;
