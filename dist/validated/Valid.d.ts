...
export declare class Valid<T, E> implements Validated<T, E> {
    ...
    assign<T extends object, K extends string, U>(this: Valid<T, E>, key: Exclude<K, keyof T>, memberOrValidatedOrFunction: Validated<U, E> | ((value: T) => Validated<U, E>) | U | ((value: T) => U)): Validated<T & {
        [key in K]: U;
    }, E>;
