...
export interface Validated<T> {
    apply<U, V>(this: Validated<(parameter: U) => V>, parameterOrFunction: U | Validated<U> | (() => U) | (() => Validated<U>)): Validated<V>;
    assign<T extends object, K extends string, U>(this: Validated<T>, key: K, memberOrFunction: Validated<U> | ((value: T) => Validated<U>) | U | ((value: T) => U)): Validated<T & {
        [key in K]: U;
    }>;
